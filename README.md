...
***
#### July 17, 2016
1. Add code to send results to Amazon's Simple Queue Service (SQS) when a queue name is provided.
1. Update permissions for IAM role **fetch_title_role**: attached **AmazonSQSFullAccess** policy.
